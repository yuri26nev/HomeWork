...
Console.WriteLine(
    "Напишите програму, которая принимает на вход пятизначное число и проверяет, является ли оно палиндромом."
);
Console.WriteLine();
...
if (namber == 19 || namber == 23 || namber == 21)
{
    switch (namber)
    {
        case 19:
            Console.WriteLine("Задача 19");
            Console.WriteLine(
                " Введите пятизначное число и я проверю является ли оно палиндромом."
            );
